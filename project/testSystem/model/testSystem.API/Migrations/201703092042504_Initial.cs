    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Users", t => t.ContactInfoId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.TestParticipations", t => t.TestParticipationId, cascadeDelete: false)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TestParticipations", "UserId", "dbo.Users");
            ...
            DropForeignKey("dbo.ContactInfoes", "ContactInfoId", "dbo.Users");
            DropForeignKey("dbo.Users", "CreatedUser_UserId", "dbo.Users");
            ...
            DropIndex("dbo.TestParticipations", new[] { "UserId" });
            ...
            DropIndex("dbo.Users", new[] { "CreatedUser_UserId" });
